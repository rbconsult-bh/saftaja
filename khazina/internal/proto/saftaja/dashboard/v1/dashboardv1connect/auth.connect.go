...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/rbconsult-bh/saftaja/internal/proto/saftaja/dashboard/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	AuthServiceName = "saftaja.dashboard.v1.AuthService"
)
...
const (
	...
	AuthServiceRegisterProcedure = "/saftaja.dashboard.v1.AuthService/Register"
	// AuthServiceInitiateLoginProcedure is the fully-qualified name of the AuthService's InitiateLogin
	// RPC.
	AuthServiceInitiateLoginProcedure = "/saftaja.dashboard.v1.AuthService/InitiateLogin"
	// AuthServiceCompleteLoginProcedure is the fully-qualified name of the AuthService's CompleteLogin
	// RPC.
	AuthServiceCompleteLoginProcedure = "/saftaja.dashboard.v1.AuthService/CompleteLogin"
	// AuthServiceRefreshTokenProcedure is the fully-qualified name of the AuthService's RefreshToken
	// RPC.
	AuthServiceRefreshTokenProcedure = "/saftaja.dashboard.v1.AuthService/RefreshToken"
	// AuthServiceLogoutProcedure is the fully-qualified name of the AuthService's Logout RPC.
	AuthServiceLogoutProcedure = "/saftaja.dashboard.v1.AuthService/Logout"
)

// AuthServiceClient is a client for the saftaja.dashboard.v1.AuthService service.
...
// NewAuthServiceClient constructs a client for the saftaja.dashboard.v1.AuthService service. By
...
func NewAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AuthServiceClient {
	...
	authServiceMethods := v1.File_saftaja_dashboard_v1_auth_proto.Services().ByName("AuthService").Methods()
...
// Register calls saftaja.dashboard.v1.AuthService.Register.
...
// InitiateLogin calls saftaja.dashboard.v1.AuthService.InitiateLogin.
...
// CompleteLogin calls saftaja.dashboard.v1.AuthService.CompleteLogin.
...
// RefreshToken calls saftaja.dashboard.v1.AuthService.RefreshToken.
...
// Logout calls saftaja.dashboard.v1.AuthService.Logout.
...
// AuthServiceHandler is an implementation of the saftaja.dashboard.v1.AuthService service.
...
func NewAuthServiceHandler(svc AuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/saftaja.dashboard.v1.AuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAuthServiceHandler) Register(context.Context, *connect.Request[v1.RegisterRequest]) (*connect.Response[v1.RegisterResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("saftaja.dashboard.v1.AuthService.Register is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) InitiateLogin(context.Context, *connect.Request[v1.InitiateLoginRequest]) (*connect.Response[v1.InitiateLoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("saftaja.dashboard.v1.AuthService.InitiateLogin is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) CompleteLogin(context.Context, *connect.Request[v1.CompleteLoginRequest]) (*connect.Response[v1.CompleteLoginResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("saftaja.dashboard.v1.AuthService.CompleteLogin is not implemented"))
}
...
func (UnimplementedAuthServiceHandler) RefreshToken(context.Context, *connect.Request[v1.RefreshTokenRequest]) (*connect.Response[v1.RefreshTokenResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("saftaja.dashboard.v1.AuthService.RefreshToken is not implemented"))
}

func (UnimplementedAuthServiceHandler) Logout(context.Context, *connect.Request[v1.LogoutRequest]) (*connect.Response[v1.LogoutResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("saftaja.dashboard.v1.AuthService.Logout is not implemented"))
}
