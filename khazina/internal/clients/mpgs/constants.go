...
const (
	...
	AuthStatusNotSupported AuthStatus = "AUTHENTICATION_NOT_SUPPORTED"
	AuthStatusNotInEffect  AuthStatus = "AUTHENTICATION_NOT_IN_EFFECT"
	AuthStatusRejected     AuthStatus = "AUTHENTICATION_REJECTED"
	AuthStatusRequired     AuthStatus = "AUTHENTICATION_REQUIRED"
	AuthStatusUnavailable  AuthStatus = "AUTHENTICATION_UNAVAILABLE"

	GatewayRecommendationProceed                     GatewayRecommendation = "PROCEED"
	GatewayRecommendationCheckTransactionStatusLater GatewayRecommendation = "CHECK_TRANSACTION_STATUS_LATER"
