...
type Querier interface {
	...
	GetCompletedAuthenticateCardholderGatewayOperation(ctx context.Context, paymentIntentID uuid.UUID) (GatewayOperation, error)
	GetCompletedCapturePaymentGatewayOperationByPaymentIntentID(ctx context.Context, paymentIntentID uuid.UUID) (GatewayOperation, error)
	GetCompletedPrepareCardAuthenticationGatewayOperation(ctx context.Context, paymentIntentID uuid.UUID) (GatewayOperation, error)
