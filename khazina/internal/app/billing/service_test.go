...
func TestVerifyCardAuthentication_RejectsInvalidState(t *testing.T) {
	tests := []struct {
		...
		{name: "created", paymentIntentID: uuidPaymentIntent},
		{name: "ready_to_authenticate", paymentIntentID: uuidPaymentReadyToAuthenticate},
	}
